...
export default function BackendHealthCheck() {
  ...
  return (
    ...
    >
      {!result && (
        <p className="text-gray-500">点击"检查后端服务"按钮开始诊断</p>
      )}
      ...
      {result && (
        <Descriptions column={1} bordered>
          <Descriptions.Item label="后端服务连接">
            ...
            {!result.backendReachable && <span className="ml-2 text-red-500">请确认后端运行在 http://localhost:8888</span>}
          </Descriptions.Item>
          ...
          <Descriptions.Item label="CORS支持">
            ...
            {!result.corsSupport && <span className="ml-2 text-orange-500">后端可能缺少CORS配置</span>}
          </Descriptions.Item>
