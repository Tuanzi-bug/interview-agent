  ...
  questions: [
    {
      ...
      reference: '该项目为RAG驱动的旅行助手，整合检索与生成，在稳定性与响应速度上做了优化，通过流式SSE提升交互体验，线下部署容器化，核心链路可用性达到99%以上。',
      followups: [
    ...
    },
    {
      ...
      reference: '采用异步管道与消息队列配合，本地向量缓存与热点文档预取，首包用SSE推送提升感知速度。',
      followups: [
        '为什么选择SSE而非WebSocket？',
        '缓存失效策略如何设计？',
      ],
...
export default function InterviewDetailPage() {
  ...
  return (
    <div className="container mx-auto px-4">
      <Title level={2} className="mt-2">押题详情</Title>
            ...
            <List
              ...
              renderItem={(item, index) => (
                <List.Item
                  ...
                  style={{ cursor: 'pointer', background: index === selected ? '#f6ffed' : undefined }}
                >
                  <List.Item.Meta
        ...
        <Col xs={24} md={18}>
          <AntCard className="rounded-2xl" styles={{ body: { padding: 24 } }}>
            <Space size={12} style={{ width: '100%', justifyContent: 'space-between' }}>
              <Title level={4} style={{ margin: 0 }}>{current.question}</Title>
              <Space>
