# 早日上岸AI智能面试平台 (AI-Eino-Interview-Agent)

基于字节跳动 Hertz 框架和 Eino 大语言模型框架开发的智能面试代理系统，助力求职者早日获得理想工作。

## 项目概述

「早日上岸AI」是一个智能面试系统，利用 Eino 框架提供的大语言模型能力，实现简历分析、面试问题生成、答案评估等功能。系统采用 Hertz 作为 Web 框架，提供 RESTful API 接口，帮助用户提升面试技能，早日拿到心仪的offer。
